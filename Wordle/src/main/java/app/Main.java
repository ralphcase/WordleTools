...
//        Solver solver = new Solver(repo, hard, Solver.Mode.ALL);
        ...
        solver.applyFeedback(new Word("ORATE"), Feedback.of(gray, gray, gray, gray, yellow));
        DictionaryBuilder.predictWordlebot(solver.remainingCandidates());

        solver.applyFeedback(new Word("SILEN"), Feedback.of(yellow, gray, gray, yellow, gray));
