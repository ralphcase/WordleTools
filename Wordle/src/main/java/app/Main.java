...
//        Solver solver = new Solver(repo, hard, Solver.Mode.ALL);
        ...
        solver.applyFeedback(new Word("SANER"), Feedback.of(gray, green, yellow, gray, gray));
        DictionaryBuilder.predictWordlebot(solver.remainingCandidates());

        solver.applyFeedback(new Word("PUTON"), Feedback.of(yellow, gray, gray, green, green));
//        solver.applyFeedback(new Word("MITCH"), Feedback.of(gray, yellow, gray, green, gray));
