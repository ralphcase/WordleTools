...
public class WordRepositoryTest {
    ...
    void nullPastSolutionsBecomesEmptyList() {
        ...
        WordRepository repo = new WordRepository(allowed, goals, null, null, null, null   );
    ...
    void goalsMustBeSubsetOfAllowed() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () ->
                new WordRepository(allowed, goals, null, null, null, null));
    }
    ...
    void listsAreDefensivelyCopied() {
        ...
        WordRepository repo = new WordRepository(allowed, goals, past,  null, null, null );
