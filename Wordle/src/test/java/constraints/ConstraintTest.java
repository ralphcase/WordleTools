...
public class ConstraintTest {
  ...
  void allowsRejectsNullCandidate() {
    Constraint c =
      new Constraint(new Word("ABCDE"), Feedback.of(ABSENT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void correctLetterMustMatchPosition() {
    Constraint c =
      new Constraint(new Word("ABCDE"), Feedback.of(CORRECT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void correctLetterDoesNotAllowDifferentLetterElsewhere() {
    Constraint c =
      new Constraint(new Word("ABCDE"), Feedback.of(ABSENT, CORRECT, ABSENT, ABSENT, ABSENT));
  ...
  void presentLetterMustAppearElsewhere() {
    Constraint c =
      new Constraint(new Word("ABCDE"), Feedback.of(PRESENT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void mixedMarksForLetterEnforceExactCount() {
    ...
    Constraint c =
      new Constraint(new Word("AABCD"), Feedback.of(PRESENT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void allPositiveMarksRequireAtLeastThatManyOccurrences() {
    ...
    Constraint c =
      new Constraint(new Word("AABCD"), Feedback.of(PRESENT, PRESENT, ABSENT, ABSENT, ABSENT));
  ...
  void pureGrayDuplicateLetterMustNotAppear() {
    ...
    // -> zero A's allowed
    Constraint c =
      new Constraint(new Word("AABCD"), Feedback.of(ABSENT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void mixedMarksForNonDuplicateLettersBehaveCorrectly() {
    ...
    Constraint c =
      new Constraint(new Word("ABCDE"), Feedback.of(ABSENT, PRESENT, ABSENT, ABSENT, ABSENT));
  ...
  void candidateWithTooFewOccurrencesIsRejected() {
    Constraint c =
      new Constraint(new Word("AABXX"), Feedback.of(PRESENT, PRESENT, ABSENT, ABSENT, ABSENT));
  ...
  void candidateWithTooManyOccurrencesIsRejected() {
    Constraint c =
      new Constraint(new Word("ABXXX"), Feedback.of(PRESENT, ABSENT, ABSENT, ABSENT, ABSENT));
  ...
  void toStringReturnsGuessTabFeedback() {
    ...
    String expected = guess + "\t" + feedback;
