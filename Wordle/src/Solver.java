...
//				true;
		...
		guesses.add(new Guess(new Position("CRAGS"), new Report(new ArrayList<String>(List.of("gray", "green", "green", "gray", "gray")))));
		guesses.add(new Guess(new Position("FIKED"), new Report(new ArrayList<String>(List.of("gray", "gray", "yellow", "yellow", "gray")))));
