...
//				true;
		...
		guesses.add(new Guess(new Position("ROATE"), new Report(new ArrayList<String>(List.of("yellow", "gray", "yellow", "gray", "gray")))));
		guesses.add(new Guess(new Position("MINCY"), new Report(new ArrayList<String>(List.of("gray", "green", "gray", "gray", "gray")))));
//		guesses.add(new Guess(new Position("WRING"), new Report(new ArrayList<String>(List.of("gray", "green", "green", "green", "green")))));
