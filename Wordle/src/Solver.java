...
//				true;
		...
		guesses.add(new Guess(new Position("CLANS"), new Report(new ArrayList<String>(List.of("gray", "yellow", "yellow", "gray", "gray")))));
//		guesses.add(new Guess(new Position("CLEFT"), new Report(new ArrayList<String>(List.of("gray", "yellow", "yellow", "gray", "green")))));
